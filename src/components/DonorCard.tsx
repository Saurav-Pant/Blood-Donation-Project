...
function DonorCard({
  ...
  return (
    <div className="rounded-xl border-8 border-red-800 w-96 h-[350px] transition duration-300 hover:scale-[1.025] cursor-pointer m-1">
      <div className="h-3/5 flex flex-col rounded bg-gray-200 p-2">
        <div className="w-full flex flex-row">
          <Image src={`/blood.svg`} width={90} height={90} alt="blood-drom" />
          <h3 className="text-[50px] font-bold text-red-700">{bloodGroup}</h3>
        </div>
