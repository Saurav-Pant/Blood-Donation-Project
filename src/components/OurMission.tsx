...
const OurMission = () => {
  return (
    <div
      className="sm:max-h-[45vh] md:max-h-[45vh] lg:h-[30vh] pt-3 mx-5 rounded-2xl relative"
    >
      <h1 className="text-4xl font-bold pl-16 pt-4 font-mono hover:text-red-800 transition-colors duration-300 ease-in-out">
        Our Mission
      </h1>
      <p
