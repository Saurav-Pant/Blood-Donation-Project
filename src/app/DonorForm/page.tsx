...
const DonorForm = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        city: Yup.string().required("City/town/village name is required"),
        pincode: Yup.number()
            .required("Pincode is required.")
            .positive("Enter a Valid Pincode")
            .integer("Enter a Valid Pincode")
            .min(100000, "Enter a Valid Pincode")
            .max(999999, "Enter a Valid Pincode"), // 6 digit pincode
        ...
        >
            ...
            <div className="shadow border-1 p-8">
                ...
                <div className="mb-5">
                    ...
                    <label
                        htmlFor="lastName"
                        className="w-full mb-[2vw] mt-2 mr-1"
                    >
                ...
                <div className="mb-5">
                    ...
                    <label
                        htmlFor="age"
                        className=" mb-[2vw] mt-2 mr-1 w-full "
                    >
                        Age {compulsory}
                    </label>
                    <input
                ...
                <div className="mb-5 ">
                    ...
                    <label htmlFor="city" className=" mt-2 mr-[2vw] w-full">
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        onBlur={formik.handleBlur}
                        className="pl-2 mb-6 border-2 border-gray-300 hover:border-red-800 h-10 w-full"
                    ...
                    {/* pincode */}
                    <label htmlFor="pincode" className=" mt-2 mr-[2vw] w-full">
                        Pincode {compulsory}
                    </label>
                    <input
                        type="number"
                        ...
                        onChange={handleInputChange}
                        onBlur={formik.handleBlur}
                        className="pl-2 mb-2 border-2 border-gray-300 hover:border-red-800 h-10 w-full"
                        placeholder="Eg. 700002"
                        required
                    />
